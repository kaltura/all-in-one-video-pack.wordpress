...
<?php if ( $this->error ): ?>
	<div class="wrap">
		...
		<p class="submit" style="text-align: left; ">
			<input type="button" value="<?php _e( 'Click here to edit partner details manually' ); ?>" onclick="window.location = 'options-general.php?page=kaltura_options&partner_login=true';" />
		</p>
	...
	<div class="wrap">
		...
		<form name="form1" method="post">
			...
			<table>
				...
				<tr valign="top">
					<td><label for="allow_anonymous_comments"><?php _e( "Allow anonymous video comments?" ); ?></label>
					</td>
					<td>
				...
				<tr>
					<td colspan="2"><a href="javascript:;" id="advanced-button"><?php _e( 'Advanced settings' ); ?></a>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
						...
						<p class="submit" style="text-align: left; ">
							<input type="submit" name="update" value="<?php _e( 'Update' ) ?>" /></p>
					</td>
				</tr>
			</table>
			<br />
